...
sts = [0.75]
# sts = [0.5,0.55,0.6,0.65,0.7,0.75,0.8,0.85,0.9]
...
for st_now in sts:
    for dataset, setting in benchmark_settings.items():
        ...
        parser = ASParser.LogParser(log_format=setting['log_format'], indir=indir,outdir=output_dir,st=st_now)
...
print(df_result)
df_result.T.to_csv('TreePatAlign2_bechmark_result.csv')
