...
def evaluate(groundtruth, parsedresult, size=0):
    ...
    accuracy_exact_string_matching = None
    ...
    edit_distance_result_mean = 0
    edit_distance_result_std = 0

    
    (precision, recall, f_measure, accuracy_PA) = get_accuracy(df_groundtruth['EventId'], df_parsedlog['EventId'])
    print('Precision: %.4f, Recall: %.4f, F1_measure: %.4f, accuracy_PA: %.4f, edit_distance_result_mean: %.4f, edit_distance_result_std: %.4f'%(precision, recall, f_measure, accuracy_PA,  edit_distance_result_mean, edit_distance_result_std))
    
    return precision, recall, f_measure, accuracy_PA,
